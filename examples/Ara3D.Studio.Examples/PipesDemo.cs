...
{
    public class PipesDemo : IAnimatedModelGenerator
    {
        [Range(10, 500)] public int GridCount = 40;
        [Range(1, 20)] public int PipeCount;
            ...
            for (var pi = 0; pi < pipes.Count; pi++)
            {
                ...
                for (var i = 1; i < p.Count; i++)
                {
                    ...
                    if (line.Length >= 1e-5f)
                    {
                        ...
                        instances.Add(new InstanceStruct(0, tr, cylIndex, mat));
                    }
                    ...
                    if (i < p.Count - 1 && IsElbowAt(p, i))
                    {
                        ...
                        instances.Add(new InstanceStruct(0, elbowTr, elbowIndex, mat));
                    }
                }
            }
